...
#define INFRARED_ERR(fmt, args...) \
	printk(KERN_ERR INFRARED_TAG" %s : "fmt, __func__, ##args)
#define INFRARED_LOG(fmt, args...) \
	printk(KERN_INFO INFRARED_TAG" %s : "fmt, __func__, ##args)


struct oneplus_infrared_state {
